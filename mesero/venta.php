  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST' && strpos($_SERVER['CONTENT_TYPE'], 'application/json') !== false) {
    ...
    try {
      ...
      if ($adicion_id) {
        ...
        $sql_update = "UPDATE comanda SET total = total + ?, estado = 'en_preparacion', editando = 0, es_anexo = 1, notificado = 0 WHERE id = ?";
  ...
  $sql_update = "UPDATE comanda SET total = ?, editando = 0, mesa_id = ?, cliente_id = ?, tipo_servicio = ?, notificado = 0 WHERE id = ?";      $stmt_update = $pdo->prepare($sql_update);
        $stmt_update->execute([
          $total_pedido,
              ...
              <div id="form-nuevo-cliente" class="new-client-card" style="display:none;">
                ...
                <div class="row g-2">
                  <div class="col-md-4">
                    ...
                    <input type="text" id="cli_cedula" class="form-control" placeholder="Ej: 12345678" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                  </div>
                  <div class="col-md-8">
                    <label class="form-label small fw-bold">Nombre Completo <span class="text-danger">*</span></label>
                    <input type="text" id="cli_nombre" class="form-control" placeholder="Ej: Juan Pérez" maxlength="40" oninput="this.value = this.value.replace(/[^a-zA-ZáéíóúÁÉÍÓÚñÑ\s]/g, '')">
                  </div>
                  <div class="col-md-6">
                    <label class="form-label small fw-bold">Teléfono<span class="text-danger"></span></label>
                    <input type="text" id="new-telefono" class="form-control" placeholder="Teléfono" maxlength="12" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                  </div>
                  <div class="col-md-6">
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="d-flex justify-content-around mb-3">
                      <input class="form-check-input" type="radio" name="tamanio" id="pequena" value="Pequena">
